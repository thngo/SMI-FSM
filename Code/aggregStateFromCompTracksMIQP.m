...
for iTrack = 1 : numTracks
    ...
    if numSeg == 1 %If no merges or splits ...
        ...
        options = sdpsettings('verbose',0,'solver','BNB','BNB.maxiter',5000,'cachesolvers',1); %% LRO Modified the solver %KJ 20210715: added cachesolvers=1 following YALMIP warning/advice
